...
if settings.reload_key_binding ~= "" then
  mp.add_key_binding(settings.reload_key_binding, "reload-resume", reload_resume)
  mp.add_forced_key_binding(settings.reload_key_binding, "reload-resume", reload_resume)
end
