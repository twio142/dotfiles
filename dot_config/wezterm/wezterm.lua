...
local config = {
  ...
  keys = {
    ...
    k.ctrl_to_tmux_prefix("4", "4"),
    k.ctrl_to_tmux_prefix("5", "5"),
    k.ctrl_to_tmux_prefix("6", "6"),
    k.ctrl_to_tmux_prefix("7", "7"),
    k.ctrl_to_tmux_prefix("8", "8"),
    k.ctrl_to_tmux_prefix("9", "9"),
    {
      mods = "SUPER",
      key = "o",
      action = act.Multiple({
